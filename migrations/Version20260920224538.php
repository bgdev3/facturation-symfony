 ...
 */
final class Version20260920224538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture CHANGE montant_ht montant_ht NUMERIC(10, 2) NOT NULL, CHANGE montant_tva montant_tva NUMERIC(10, 2) NOT NULL, CHANGE montant_ttc montant_ttc NUMERIC(10, 2) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture CHANGE montant_ht montant_ht VARCHAR(255) NOT NULL, CHANGE montant_tva montant_tva VARCHAR(255) NOT NULL, CHANGE montant_ttc montant_ttc VARCHAR(255) NOT NULL');
